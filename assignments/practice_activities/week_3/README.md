...
10. **Theme and width.** The *Theme* button cycles Auto / Light / Dark. Narrow the window below ~700 px: the two panels should stack and tables should scroll horizontally rather than overflow the page.
