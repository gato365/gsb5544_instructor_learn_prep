...
- `assignments/practice_activities/week_3/`
  ...
  - `distances_between_observations/` — PA 3.2 (Distances Between Observations; Ames housing and College Scorecard data). PA student/solution copies are built by `tools/build_week3_pas.py`
