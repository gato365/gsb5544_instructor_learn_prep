...
- `assignments/practice_activities/week_3/`
  ...
  - `*-extended.ipynb` in both directories — fully worked, colour-coded, step-by-step walkthroughs of Topic 3.1, PA 3.1, and PA 3.2, built by `tools/build_week3_extended.py`
...
`-extended.ipynb` — executed walkthrough with reasoning for every step and colour-coded before/after tables (no student version; listed as an *Extended* row on the site).
